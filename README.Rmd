...
The [`{provolleyballr}`](https://jeffreyrstevens.github.io/provolleyballr) R package provides tools for scraping match statistics and player data from the Athletes Unlimited (UA) website <https://auprosports.com/volleyball>, and the Major League (MLV) website <https://provolleyball.com> (formerly the Pro Volleyball Federation).
...
The package includes pre-scraped datasets (using `group_stats()` aggregating function) for analysis that includes all AU player data from 2021-2025 and all LOVB and MLV team and player data for 2024-2025.
