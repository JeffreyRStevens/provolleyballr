...
to retrieve team or individual player statistics from a particular
league:
...
respectively. For player data, AU only needs a year, and LOVB and MLV
need the team name and `level = "player"`.
...
To get team data for LOVB and MLV, use
[`lovb_stats()`](https://jeffreyrstevens.github.io/provolleyballr/reference/lovb_stats.md)
and
[`mlv_stats()`](https://jeffreyrstevens.github.io/provolleyballr/reference/mlv_stats.md)
...
The package includes five main datasets created with the
